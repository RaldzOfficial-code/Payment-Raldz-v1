  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    body {
      ...
      background: url('https://files.catbox.moe/zdij8q.jpg') no-repeat center center fixed;
    ...
    .collapsible {
      background: linear-gradient(135deg, #cfcfcf, #ffd000);
      color: #fff;
      cursor: pointer;
      padding: 14px 20px;
      width: 100%;
    ...
    .btn-link, .btn-links {
      padding: 14px 24px;
      background: linear-gradient(45deg, #cfcfcf, #cfcfcf, #ffd000, #271e4a);
...
<div id="welcome-message" class="welcome-message">
  <h1>HAI MAS/MBAK SALAM KENAL SAYA Raldz Official</h1>
...
<div id="main-content">
  ...
  <div class="qr">
    <img src="https://files.catbox.moe/uefwyj.jpg" />
  </div>

  <p class="subtitle">Selain Payment dibawah sudah dipastikan itu clone !!</p>

  <div class="collapsible-container">
    <button class="collapsible">DANA</button>
    <div class="content">
      <p><strong>DANA:</strong> 085187375530</p>
      <p><strong>ATAS NAMA:</strong> Raldz Official</p>
    </div>
    
    <button class="collapsible">GOPAY</button>
    <div class="content">
      <p><strong>GOPAY:</strong> 085717026599</p>
      <p><strong>ATAS NAMA:</strong> Raldz Official</p>
    </div>
  ...
  <div class="btn-group">
    <a href="https://t.me/RaldzLonely1<" class="btn-link" target="_blank">Telegram</a>
    <a href="https://t.me/aboutraldzofficial" class="btn-link" target="_blank">Information</a>
